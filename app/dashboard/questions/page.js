      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {activeTab === 'faq' && (
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Everything you need to know about AI Mock Interviewer</p>
            </div>
        ...
        {activeTab === 'sample' && (
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Experience Our AI-Generated Questions</h2>
              <p className="text-gray-600">See the quality and variety of interview questions our AI creates for different roles</p>
            </div>
              ...
              {sampleQuestions[selectedRole].map((question, index) => (
                <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex flex-col gap-2">
                    ...
                    />
                    <button
                      className="mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:shadow transition"
                    ...
                    {aiFeedback[question] && (
                      <div className={`rounded-lg p-3 text-sm mt-2 border ${getFeedbackColor(aiFeedback[question].rating)}`}>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Experience the Full Power?</h3>
        ...
        {activeTab === 'contact' && (
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Have a specific question? We're here to help you succeed</p>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@aimockinterviewer.com</p>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Live Chat on Email</h4>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Self-service resources</p>
